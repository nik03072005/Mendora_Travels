        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Domestic Tour Packages - Book Now At Best Prices
            </h1>
            
            <p className="text-xl text-gray-600 leading-relaxed">
              Discover The Beauty of India - Find The Perfect Domestic Tour Package Today!
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              ...
              <div className="text-center p-4 bg-white rounded-xl shadow-md">
                <div className="text-3xl font-bold text-orange-600">18K+</div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-orange-600 hover:to-orange-700 transform hover:scale-105 transition-all duration-200 shadow-lg"
              >
                Get Free Quote
              </button>
            </form>
...
export default DomesticHeroSection;
