...
const BaliTourPackagesPage = () => {
  ...
  const groupTours = [
    { id: 1, name: "Bali Adventure Group", date: "April 20, 2026", seats: 12, booked: 8, price: "₹45,999", duration: "6 Days", highlights: ["Ubud Culture", "Beach Activities", "Temple Tours"] },
    { id: 2, name: "Cultural Bali Tour", date: "May 15, 2026", seats: 15, booked: 11, price: "₹49,999", duration: "7 Days", highlights: ["Rice Terraces", "Traditional Dance", "Local Markets"] },
    { id: 3, name: "Beach & Temples", date: "June 25, 2026", seats: 10, booked: 6, price: "₹54,999", duration: "6 Days", highlights: ["Seminyak Beach", "Tanah Lot", "Water Sports"] },
    { id: 4, name: "Bali Honeymoon Group", date: "August 10, 2026", seats: 8, booked: 5, price: "₹59,999", duration: "7 Days", highlights: ["Romantic Spots", "Candlelight Dinner", "Spa Experience"] }
  ];
