...
const MaldivesTourPackagesPage = () => {
  ...
  const groupTours = [
    { id: 1, name: "Maldives Paradise", date: "April 15, 2026", seats: 12, booked: 9, price: "₹89,999", duration: "5 Days", highlights: ["Beach Resort", "Water Villa", "Snorkeling"] },
    { id: 2, name: "Island Hopping Group", date: "June 20, 2026", seats: 10, booked: 7, price: "₹99,999", duration: "6 Days", highlights: ["Multiple Islands", "Local Culture", "Beach Activities"] },
    { id: 3, name: "Diving Adventure", date: "July 25, 2026", seats: 8, booked: 5, price: "₹1,09,999", duration: "7 Days", highlights: ["Scuba Diving", "Marine Life", "Water Sports"] },
    { id: 4, name: "Luxury Escape", date: "September 10, 2026", seats: 6, booked: 4, price: "₹1,19,999", duration: "6 Days", highlights: ["5-Star Resort", "Private Beach", "Spa Treatments"] }
  ];
